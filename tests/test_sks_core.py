...
_extract_reg_dt = sks_core._extract_reg_dt
...
def test_extract_reg_dt_uses_configured_key_first():
    item = {"CUSTOM_DATE": "2026/06/13", "RDATE": "20260612"}

    assert _extract_reg_dt(item, {"date_key": "CUSTOM_DATE"}, "") == "20260613"


def test_extract_reg_dt_falls_back_to_pdf_filename():
    item = {"RDATE": ""}
    pdf_path = "/Upload/Research/20260612083650333_0_ko.pdf"

    assert _extract_reg_dt(item, {}, pdf_path) == "20260612"


def test_extract_reg_dt_does_not_use_unrelated_digits():
    assert _extract_reg_dt({}, {}, "/Upload/Research/report_123456.pdf") == ""
