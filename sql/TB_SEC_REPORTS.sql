...
--
-- Name: idx_tb_sec_reports_reg_dt_firm_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tb_sec_reports_reg_dt_firm_id ON public.tbl_sec_reports USING btree (reg_dt DESC, firm_id);
