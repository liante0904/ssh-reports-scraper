#!/usr/bin/env python3
"""
교보증권 리포트 다운로드 URL 후처리 스크립트

문제:
  교보증권 모듈(Kyobo_24.py)에서 수집된 URL은 https://www.iprovest.com/upload/... 형태로
...
if __name__ == "__main__":
    ...
    log_file = os.path.join(log_dir, "fix_kyobo_db.log")
